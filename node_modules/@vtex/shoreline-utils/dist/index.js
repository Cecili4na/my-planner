...
__export(src_exports, {
  Store: () => Store,
  camelCase: () => import_scule.camelCase,
  canUseDOM: () => canUseDOM,
  chain: () => chain,
  cleanTokenString: () => cleanTokenString,
  constants: () => constants,
  cssVar: () => cssVar,
  cx: () => cx,
  flattenObject: () => flattenObject,
  forwardRef: () => forwardRef2,
  hasSomeTextSelected: () => hasSomeTextSelected,
  invariant: () => import_tiny_invariant.default,
  isFunction: () => isFunction,
  isNativeHandler: () => isNativeHandler,
  isString: () => isString,
  isStringEmpty: () => isStringEmpty,
  isToken: () => isToken,
  isUppercase: () => import_scule.isUppercase,
  kebabCase: () => import_scule.kebabCase,
  lowerFirst: () => import_scule.lowerFirst,
  merge: () => merge,
  mergeProps: () => mergeProps,
  mergeRefs: () => mergeRefs,
  parseTokens: () => parseTokens,
  pascalCase: () => import_scule.pascalCase,
  shallowCompare: () => shallowCompare,
  snakeCase: () => import_scule.snakeCase,
  splitByCase: () => import_scule.splitByCase,
  style: () => style,
  toVar: () => toVar,
  upperFirst: () => import_scule.upperFirst,
  useControlledState: () => useControlledState,
  useId: () => useId,
  useMergeRef: () => useMergeRef,
  useSafeLayoutEffect: () => useSafeLayoutEffect,
  useStore: () => useStore,
  warning: () => import_tiny_warning.default
});
...
function merge(...params) {
  return import_deepmerge.default.all([...params].filter((p) => p));
}
...
function useControlledState(value, defaultValue, onChange) {
  const [stateValue, setStateValue] = (0, import_react2.useState)(value || defaultValue);
  const isControlledRef = (0, import_react2.useRef)(value !== void 0);
